...
def test_v4_logic():
    ...
    r1 = classify_risk(0.1, GleasonScore.GG1, TumorStage.PT2, 20, PetFindings.PELVIC_LN, MarginStatus.R0)
    assert r1 == RiskLevel.VERY_HIGH, f"N1 should be VERY_HIGH, got {r1}"
    print("PASS: N1 -> Very High")
    
    # Case 2: VERY HIGH Risk (PSADT <= 6)
    r2 = classify_risk(0.1, GleasonScore.GG1, TumorStage.PT2, 5.0, PetFindings.NEGATIVE, MarginStatus.R0)
    ...
    r3 = classify_risk(0.1, GleasonScore.GG4, TumorStage.PT2, 20, PetFindings.NEGATIVE, MarginStatus.R0, has_psa_persistence=True)
    ...
    r4 = classify_risk(0.1, GleasonScore.GG1, TumorStage.PT2, 20, PetFindings.NEGATIVE, MarginStatus.R0, has_psa_persistence=True)
    ...
    r5 = classify_risk(0.1, GleasonScore.GG4, TumorStage.PT2, 20, PetFindings.NEGATIVE, MarginStatus.R0)
    assert r5 == RiskLevel.HIGH, f"GG4 should be HIGH, got {r5}"
    print("PASS: GG4 -> High")
    
    # Case 6: INTERMEDIATE Risk (GG3 + pT2)
    r6 = classify_risk(0.6, GleasonScore.GG3, TumorStage.PT2, 20, PetFindings.NEGATIVE, MarginStatus.R0)
